...
An MCP server that lets AI assistants read, edit, and execute Jupyter notebooks with real-time collaboration. Designed in collaboration with agents actively using it and giving feedback ([For Agents, by Agents](./dogfooding/)). Tools are built to preserve agent context — outlines, diffs, incremental change polling, and image limits let agents stay aware of what's happening without burning through their context window. Changes appear instantly in your browser — no reloading. The server sees where your cursor is and won't touch the cell you're editing.
