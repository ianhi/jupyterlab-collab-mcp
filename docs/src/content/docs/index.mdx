...
An MCP server that lets AI assistants read, edit, and execute Jupyter notebooks with real-time collaboration. Changes appear instantly in your browser — no reloading. Claude sees where your cursor is and won't touch the cell you're editing.
